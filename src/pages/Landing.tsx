    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/5 to-background">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-8 animate-fade-in">
            The definitive zero-trust security platform for MCP-based AI agents. One-liner protection that evolves into comprehensive runtime shield, preventing breaches and ensuring compliance <strong>without a single line of effort</strong>.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-12 animate-fade-in">
            <Button size="lg" className="text-lg px-8 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 shadow-lg hover:shadow-xl transition-all">
              Start Free Trial
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-8 hover:bg-primary/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                <div className="text-4xl font-bold text-primary mb-2">$207.9B</div>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                <div className="text-4xl font-bold text-destructive mb-2">$4.5M</div>
      ...
      {/* Problem Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-destructive/5 to-orange-500/5">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">The AI Security Crisis</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-destructive/20 hover:shadow-lg transition-all hover:border-destructive/40">
              <CardHeader>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">The MCPGuard Solution</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="hover:shadow-lg transition-all hover:scale-105 group">
                <CardHeader>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-primary/5 to-accent/5">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Enterprise Customer Segments</h2>
            ...
            {segments.map((segment, index) => (
              <Card key={index} className="hover:shadow-lg transition-all hover:scale-105">
                <CardHeader>
                  ...
                  <CardDescription className="font-medium">{segment.examples}</CardDescription>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingTiers.map((tier, index) => (
              <Card key={index} className={`relative hover:shadow-lg transition-all hover:scale-105 ${
                ...
                <CardContent>
                  ...
                  <Button className={`w-full ${tier.popular ? 'bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90' : ''}`} 
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 bg-gradient-to-r from-primary to-accent relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button size="lg" variant="secondary" className="text-lg px-8 shadow-lg hover:shadow-xl">
              Start Free Trial
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 border-t bg-background/95">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">The invisible fortress for AI agents</p>
              </div>
            </div>
